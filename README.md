...
##  Official Workspace 🚀
The primary home for our interactive documentation and live collections is:
 **[http://postman.com/wikimedia-enterprise](http://postman.com/wikimedia-enterprise)**
...
3.  **Configure Auth**: 
    *  Create an account at [https://dashboard.enterprise.wikimedia.com/signup/](https://dashboard.enterprise.wikimedia.com/signup/).
    *  Add your username and password to the `{{wmeUsername}}` and `{{wmePassword}}` to generate your `access_token` Bearer token and `refresh_token`.
    *  Make your first call! We suggest testing out your first calls with the On-demand Article Lookup endpoint.
